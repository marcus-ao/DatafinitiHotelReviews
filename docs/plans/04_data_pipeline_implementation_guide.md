...
> 版本：v2.0-final
> 前置文档：`docs/plans/data_pipeline_plan.md`
...
- 若未安装 `en_core_web_sm`，`split_reviews_into_sentences.py` 会自动回退到 `sentencizer`
...
**脚本**: `scripts/pipeline/load_and_filter_reviews.py`  
...
**脚本**: `scripts/pipeline/clean_and_dedupe_reviews.py`  
...
**脚本**: `scripts/pipeline/split_reviews_into_sentences.py`  
...
**脚本**: `scripts/pipeline/classify_sentence_aspects.py`  
...
**脚本**: `scripts/pipeline/classify_aspect_sentiment.py`  
...
**脚本**: `scripts/pipeline/build_hotel_aspect_profiles.py`  
...
**脚本**: `scripts/pipeline/build_evidence_vector_index.py`  
...
**脚本**: `scripts/pipeline/load_kb_to_postgres.py`  
**输入**: 当前所有中间 `.pkl`  
...
**脚本**: `scripts/pipeline/validate_kb_assets.py`
...
最终验收以 `validate_kb_assets.py = 28/28 通过` 为准。
